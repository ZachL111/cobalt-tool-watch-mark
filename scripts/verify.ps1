...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt-tool-watch-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt-tool-watch-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt-tool-watch-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cobalt_tool_watch_mark-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

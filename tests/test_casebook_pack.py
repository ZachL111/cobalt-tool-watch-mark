"""Regression checks for the cobalt-tool-watch-mark casebook."""
...
from casebook.harness import assert_expected, cobalt_tool_watch_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_tool_watch_mark_summary(), assert_expected())
